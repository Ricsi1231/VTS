...
# tagsagi fuggvenyek
quality['borzaszto'] = fuzz.gaussmf(quality.universe, 5, 5)
quality['kozepes'] = fuzz.gaussmf(quality.universe, 5, 10)
quality['finom'] = fuzz.gaussmf(quality.universe, 10, 15)

service['rossz'] = fuzz.gaussmf(service.universe, -5, 15)
service['elfogadthato'] = fuzz.gaussmf(service.universe, 5, 10)
service['kituno'] = fuzz.gaussmf(service.universe, 10, 15)

tip['alacsony'] = fuzz.gaussmf(tip.universe, 0, 13)
tip['kozepes'] = fuzz.gaussmf(tip.universe, 13, 25)
tip['magas'] = fuzz.gaussmf(tip.universe, 25, 25)
